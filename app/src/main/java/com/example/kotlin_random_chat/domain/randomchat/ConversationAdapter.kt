...
import com.example.kotlin_random_chat.databinding.MessageByReceiverBinding
import com.example.kotlin_random_chat.databinding.MessageBySenderBinding

class ConversationAdapter(private val context: Context) :
    RecyclerView.Adapter<ConversationAdapter.MessageBoxViewHolder>() {
